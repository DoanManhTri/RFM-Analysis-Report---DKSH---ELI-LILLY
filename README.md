...
- **Advanced Data Analysis:** Proficient use of Power BI and advanced DAX calculations to perform RFM segmentation and analyze customer data from 2,518 transactions.
...
## Data Source
My data comes from wholesale transactions at pharmacies distributed by DKSH. The anonymized dataset includes 2,518 transactions of 16 SKUs sold to 314 customers over two years. (The data used in this report is a test sample)
## Features
